...
impl Plugin for WebsocketPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_system(convertion::send_system.label(AppLabels::Websocket).after(AppLabels::Ui));
        app.add_system(convertion::receive_system.label(AppLabels::Websocket).after(AppLabels::Ui));
